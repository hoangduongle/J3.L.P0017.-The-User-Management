...
public class LoginController extends HttpServlet {
    ...
    private static final String ADMIN = "manager.jsp";
    private static final String MEMBER = "profile.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            passWord = dao.Sha256(passWord);
            UserDTO dto = dao.checkAccount(userName, passWord);
