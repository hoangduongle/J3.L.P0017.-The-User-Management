...
public class EditController extends HttpServlet {
    ...
    private static final String SUCCESS = "detailpromotion.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<DetailDTO> list = (ArrayList<DetailDTO>) session.getAttribute("DETAIL");
            for (DetailDTO detailDTO : list) {
                if(detailDTO.getUserID() == Integer.parseInt(userID)){
                    detailDTO.setRank(Integer.parseInt(rank));
                }
            }
            session.setAttribute("DETAIL", list);
            request.setAttribute("MESSOK", "Edit Success!");
            url = SUCCESS;
        } catch (Exception e) {
