...
public class HistoryController extends HttpServlet {
    ...
    private static final String SUCCESS = "historypromotion.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<HistoryDTO> list = dao.getListHistoryByID(Integer.parseInt(userid));
            ...
            if (list != null) {
                ...
                for (HistoryDTO historyDTO : list) {
                    for (PromotionDTO promotionDTO : listpro) {
                        if(historyDTO.getPro().getProID() == promotionDTO.getProID()){
                            historyDTO.setPro(promotionDTO);
                        }
                    }
                }
            }
